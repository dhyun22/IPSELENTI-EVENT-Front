...
function ShareModal() {
    ...
    const getInfo = async () => {
        const result = await axios.get(process.env.REACT_APP_HOST+"/user/shareInfo/most", {withCredentials:true});
        console.log('hear0')
        console.log(result);
        ...
        <div>
            ...
            onRequestClose={() => setModalOpen(false)}>
                ...
                <div className='shareInfo'>
                    ...
                    <div style={{display:'flex', fontSize:'1.5vh', marginTop:'1.5vh', flexDirection:'row'}}><div style={{color: '#747474'}}>현재 배당률</div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{Math.round((shareInfo.total_amount / shareInfo.celebrity_amount) * 100) / 100} x</div></div>
                    <div style={{display:'flex', fontSize:'1.5vh', marginTop:'1.5vh', flexDirection:'row'}}><div style={{color: '#747474'}}>예상 배당금</div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{Math.round((shareInfo.total_amount / shareInfo.celebrity_amount) * 100) / 100 * Math.round(shareInfo.betting_amount)} P</div></div>
